...
set INPUT_DIRPATH=%3
set OUTPUT_DIRPATH=%4
set OUTPUT_FILENAME_PREFIX=%5
set INSTALLER_SCRIPT_FILENAME=%6

"%INNO_SETUP_COMPILER_FILEPATH%" /DPLUGIN_NAME="%PLUGIN_NAME%" /DPLUGIN_VERSION="%PLUGIN_VERSION%" /DINPUT_DIRPATH="%INPUT_DIRPATH%" /DOUTPUT_DIRPATH="%OUTPUT_DIRPATH%" /DOUTPUT_FILENAME_PREFIX="%OUTPUT_FILENAME_PREFIX%" "%INSTALLER_SCRIPT_FILENAME%"
...
:usage
echo Usage: %~n0%~x0 PLUGIN_NAME PLUGIN_VERSION INPUT_DIRPATH OUTPUT_DIRPATH OUTPUT_FILENAME_PREFIX INSTALLER_SCRIPT_FILENAME
