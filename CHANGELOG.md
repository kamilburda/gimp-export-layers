...
**This is very likely the last release of Export Layers. For GIMP 3, you can use [Batcher](https://kamilburda.github.io/batcher/), a successor to this plug-in that is also capable of batch image file conversion and exporting images opened in GIMP.**
