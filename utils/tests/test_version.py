...
class TestVersion(unittest.TestCase):
  ...
  def test_parse_version_string(
    ...
    ver = version.Version.parse(version_str)
  ...
  def test_parse_version_string_invalid_format_raises_error(
    ...
    with self.assertRaises(version.InvalidVersionFormatError):
  ...
  def test_str(self, test_case_name_suffix, version_values, expected_str):
    self.assertEqual(str(version.Version(*version_values)), expected_str)
  ...
  def test_increment(
        ...
        expected_str):
    ver = version.Version(*version_values)
